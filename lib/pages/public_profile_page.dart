...
class PublicProfilePage extends StatelessWidget {
  ...
  String _normalizeLang(dynamic raw) {
    ...
    if (lower == 'ingles' || lower == 'inglês' || lower == 'english')
      return 'Inglês';
    if (lower == 'frances' || lower == 'francês' || lower == 'french')
      return 'Francês';
    if (lower == 'espanhol' || lower == 'spanish') return 'Espanhol';
    if (lower == 'alemao' || lower == 'alemão' || lower == 'german')
      return 'Alemão';
  ...
  // Online status: PresenceWatch (Realtime Database).
        ...
        return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snap) {
            ...
            if (data == null) {
              return Scaffold(
                appBar: AppBar(title: Text(t.get('profile'))),
                body: Center(child: Text(t.get('profile_not_found'))),
              );
            }
            ...
            final photoUrl =
                (data['photoUrl'] ?? data['photoURL'] ?? '').toString().trim();
