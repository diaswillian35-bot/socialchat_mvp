...
enum ShareL10n {
  static let en: [String: String] = [
    ...
    "share_cancel": "Cancel",
    "share_send": "Send",
    "share_select_hint": "Select a chat or group",
  ...
  static let ptBR: [String: String] = [
    ...
    "share_send": "Enviar",
    "share_select_hint": "Selecione uma conversa ou grupo",
  ...
  static let es: [String: String] = [
    ...
    "share_cancel": "Cancelar",
    "share_send": "Enviar",
    "share_select_hint": "Selecciona un chat o grupo",
  ...
  static let fr: [String: String] = [
    ...
    "share_send": "Envoyer",
    "share_select_hint": "Sélectionnez une discussion ou un groupe",
